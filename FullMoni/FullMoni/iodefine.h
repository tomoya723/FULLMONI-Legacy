...
//
// filename		:	iodefine.h
// brief		:	FullMoni rev.C IO DEFINE
// author		:	Tomoya Sato
// update		:	2021/02/21
// version		:	1.06
// --------------------------------------------------------------------
...
/************************************************************************/
/*      H8SX/1655 Group Include File                       Version 1.0  */
/************************************************************************/
...
struct st_intc {                                        /* struct INTC  */
               ...
               union {                                  /* IPRL         */
                     ...
                     struct {                           /*  Bit  Access */
                            unsigned short       :1;    /*              */
                            unsigned short _SCI2 :3;    /*    SCI2      */
                            unsigned short       :5;    /*              */
                            unsigned short _SCI4 :3;    /*    SCI4      */
                            unsigned short       :1;    /*              */
                            unsigned short _TPU6A:3;    /*    TGI6ABCD  */
                            }     BIT;                  /*              */
                     }          IPRL;                   /*              */
#endif
#if 0                     
...
struct st_da {                                          /* struct D/A   */
             unsigned char      DADR0H;                 /* DADR0H       */
             unsigned char      DADR1H;                 /* DADR1H       */
             union {                                    /* DACR01       */
                   unsigned char BYTE;                  /*  Byte Access */
                   struct {                             /*  Bit  Access */
...
#define FONT    ( (volatile unsigned int    *)0x00F800) /* FONT  Address*/
#define BASE    ( (volatile unsigned int    *)0x035000) /* BASE  Address*/
#define TITLE   ( (volatile unsigned int    *)0x05A800) /* TITLE Address*/
#define ADATA   ( (volatile unsigned int    *)0x200000) /* ADATA Address*/
#define BDATA   ( (volatile unsigned int    *)0x225800) /* BDATA Address*/
#define FONTR   ( (volatile unsigned int    *)0x24B000) /* BDATA Address*/
#define LCD_D   (*(volatile unsigned int    *)0x400000) /* LCD_D Address*/
...
#define AD0     (*(volatile struct st_ad0   *)0xFFEADA) /* A/D0  Address*/
